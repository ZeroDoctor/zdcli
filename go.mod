module github.com/zerodoctor/zdcli
...
require (
	...
	github.com/zerodoctor/zdtui v0.0.0-20230505041550-c0eab29f3dea
	github.com/zerodoctor/zdvault v0.0.0-20221231063203-bb8dbc5fc7aa
)
